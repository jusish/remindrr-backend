...
export const createReminder = async (userId: string, reminderData: Partial<IReminder>) => {
...
export const editReminder = async (reminderId: string, updateData: Partial<IReminder>) => {
...
export const markAsImportant = async (reminderId: string) => {
...
export const filterAndSortReminders = async (userId: string, filters: any, sortOptions: any) => {
    const query: { user: string; due_date?: Date; isFavorite?: boolean } = { user: userId }
